...
### 7. Inferência de MIME Type (`GuessMimeType`)
...
### 8. Variáveis de Ambiente (`IniciarVariaveisAmbiente`)
...
### 9. Processamento de Strings (`ProcessaUneStrings`)
...
### 10. Salvar Credenciais (`SalvarCredenciais`)
...
### 11. Gerenciamento de Storage (`Storage`)
...
### 12. Conversão Booleana (`StringToBool`)
...
### 13. Conversão de Fuso Horário (`TempoToBrasilia`)
...
### 14. Validação de Links Gsutil (`ValidarGsutilLink`)
...
### 15. Validação de Tipos (`VerificaTipo`)
