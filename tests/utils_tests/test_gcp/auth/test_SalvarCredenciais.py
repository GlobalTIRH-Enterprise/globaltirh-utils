...
from helpers.gcp.auth.SalvarCredenciais import salvar_credenciais


class TestSalvarCredenciais(unittest.TestCase):

    @patch("helpers.gcp.auth.SalvarCredenciais.log")
    ...
    @patch("helpers.gcp.auth.SalvarCredenciais.Path")
